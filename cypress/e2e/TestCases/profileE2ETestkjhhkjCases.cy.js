...
import createProfileE2EPage2 from "../../integration/page/createProfileE2EPage copy";
...
context("profileTestCases", () => {
  ...
  let createProfile = new createProfileE2EPage2();
  ...
  describe("Create Profiles And Validate Values", () => {
    it("Run And Validate Create Profile E2E Workflow", () => {
      ...
      let profileInfo = createProfile.enterProfileInfo2();
      let profileInfo2 = createProfile.dataSet();
      //Submit
 ...
 */
      expect(dashboard.dynamicValue(profileInfo2.get("profileE2ETextField"))).to
        .exist;
      expect(dashboard.dynamicValue(profileInfo2.get("profileE2ETextArea"))).to
        .exist;
      expect(dashboard.dynamicValue(profileInfo2.get("profileE2EDate"))).to
        .exist;
