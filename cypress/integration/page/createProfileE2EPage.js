class createProfileE2EPage {
    ...
    profileE2ETextField() {
      return cy.xpath("//*[@name = 'workflow_session[attr_profilee2etextfiled_ne_attribute]']");
    }
    //file upload button for ProfileE2EAttachment
    profileE2EAttachment() {
      return cy.xpath("//*[@name = 'workflow_session[attr_profilee2eattachment_ne_attribute]'and @type='file']");
    }
    ...
    profileE2EDate() {
      return cy.xpath("//*[@name = 'workflow_session[attr_profilee2edate_ne_attribute]']");
    }
    //profileE2EProfileSearch    
    profileE2EProfileSearch() {
      return cy.xpath("//label[text()='ProfileE2EProfileSearch']/../following-sibling::div/ul/following-sibling::div/div/following-sibling::input");
     
    }
    profileE2EProfileSearchAAA() {
        return cy.xpath("//li[text()='AAA']");
    ...
    profileE2EOwnerSelect() {
      return cy.xpath("//label[text()='ProfileE2EOwnerSelect']/parent::div/following-sibling::div/div/*[@class='selectric']");
    }
    profileE2EOwnerSelectQa5() {
        return cy.xpath("//label[text()='ProfileE2EOwnerSelect']/parent::div/following-sibling::div/div/*[@class='selectric']/following-sibling::div/div/ul/li[text()='QATester5@seczetta.com (pleasedontfreakingbreak@gmail.com)']");
      }

    //profileE@EOwnerSelect
    profileE2EContributorSelect() {
    return cy.xpath("//label[text()='ProfileE2EContributorSelect']/parent::div/following-sibling::div/div/*[@class='selectric']");
  }
  //locator for qa5 in dropdown
  profileE2EContributorSelectQA5() {
      return cy.xpath("//label[text()='ProfileE2EOwnerSelect']/parent::div/following-sibling::div/div/*[@class='selectric']/following-sibling::div/div/ul/li[text()='QATester5@seczetta.com (pleasedontfreakingbreak@gmail.com)']");
    }
    ...
    profileE2Etags() {
      return cy.xpath("(//label[text()='ProfileE2Etags']/../following::input)[2]");
    }
    //profileE2ETextArea input
    profileE2ETextArea() {
        return cy.xpath("//*[@name = 'workflow_session[attr_profilee2etextarea_ne_attribute]']");
      }
    ...
    enterProfileInfo() {
      ...
      this.profileE2EOwnerSelectQa5().click();
      //Need assertiom

      //Select Q5 as Contributor
      /*
      this.profileE2EContributorSelect().click();
      this.profileE2EContributorSelectQA5().scrollIntoView();
      this.profileE2EContributorSelectQA5().click();
        */

      //Enter AAA into profile search
      this.profileE2EProfileSearch().type("AAA");
      this.profileE2EProfileSearchAAA().click();
      //need assertion
      return profileInfo;
    }
  }
